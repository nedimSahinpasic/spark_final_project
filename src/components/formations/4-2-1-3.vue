<template>
  <div id="pitch">
    <div id="formation">
      ...
      <div id="am" class="playerDiv">
        <div
          class="playerLoaded"
          v-for="(player, index) in filter('am')"
          :key="index"
          @click="removeFromFav('AM', 'am', player)"
        >
          <div class="playerPic">
            <img :src="player.formationPicture" />
          </div>
        ...
        <button class="player" @click="select('AM', 'am')"></button>
      </div>
